# MSCredentialBot - `msCredentialBot`
...
3. Give the bot a handle (ex: `msCredentialBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://mscredentialbot.azurewebsites.net/api/messages`
